...
class FileLogger:
    ...
    def log(self, data, step):
        ...
        self.fp.write(json.dumps(data, default=_json_metric_value) + "\n")
        # A metrics file should remain useful even if a later training step
        # fails; do not leave completed records buffered in the worker.
        self.fp.flush()
...
def _json_metric_value(value):
    """Convert common metric containers without changing scalar values."""
    try:
        import torch
