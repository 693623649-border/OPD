...
**2×A100 本地复现 / local reproduction:** [轻量复刻版（推荐）](reproduce_4b/LITE_REPRODUCTION_zh.md) · [完整论文复现入口](reproduce_4b/FULL_REPRODUCTION_zh.md) · [环境与单次运行指南](reproduce_4b/README_zh.md) · [正式消融矩阵](reproduce_4b/ABLATIONS_zh.md) · [论文精读](paper/rethinking_opd_summary_zh.md)
